...
CREATE TABLE conversations(id SERIAL PRIMARY KEY, username TEXT, header TEXT, content TEXT, deleted_at TIMETZ, created_at TIMETZ DEFAULT current_timestamp, category INT, FOREIGN KEY (category) REFERENCES categories(id));
